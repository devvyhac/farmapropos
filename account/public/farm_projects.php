...
$category = "SELECT p.*, f.*, farm.*, type.*, cat.*, pay.*, u.* FROM farm_projects AS p 
             INNER JOIN funding as f ON p.id = f.project 
             ...
             INNER JOIN payments as pay ON pay.funding = f.funding_id
             INNER JOIN users as u ON u.user_id = :user_id and u.user_id = pay.user_id";
