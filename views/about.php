...
?>
  ...
  <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(https://images.pexels.com/photos/1213859/pexels-photo-1213859.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500);">
  ...
  <!-- ##### Breadcrumb Area End ##### -->
    ...
    <!-- ##### About Us Area Start ##### -->
  <section class="about-us-area bg-white">
    <div class="container">
      <div class="row align-items-center">

        <!-- About Us Content -->
        <div class="col-12 col-md-8">
          <div class="about-us-content mb-100 mt-100">
            <!-- Section Heading -->
            ...
            <a href="#" style="background: #458B0B" class="btn famie-btn mt-30">Read More</a>
          </div>
        </div>
  ...
  <section class="famie-benefits-area pb-5 bg-white">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <div class="section-heading text-center">
            <p>Farm Apropos</p>
            <h2><span>How We</span> Operate</h2>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-6 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="100ms">
            <img src="img/core-svg/invest.svg" alt="" style="width: 200px">
            <h5>You Invest</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="500ms">
            <img src="img/core-svg/we-farm.svg" alt="" style="width: 200px">
            <h5>We Farm</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="700ms">
            <img src="img/core-svg/we-sell.svg" alt="" style="width: 200px">
            <h5>We Sell</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="900ms">
            <img src="img/core-svg/profit.svg" alt="" style="width: 200px">
            <h5>You Make Profit</h5>
          </div>
        </div>
      </div>
